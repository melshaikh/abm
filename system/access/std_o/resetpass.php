<?php include '../tols/heads.inc.php'; if(isStudentLoggedIn()){$loginuser = isStudentLoggedIn();?>
<html dir="ltr" lang="en">
<?php include 'printsreset.php'; ?>
<head>
    <meta charset="utf-8">
                        ...
                        <div class="card">
                            <div class="card-body row">
                                <div class="col-sm-3" style="max-height: 300">
                                    <img class="rounded-circle" src="../../../user_files/unknown.png" style="width: inherit; max-height: inherit">
                                </div>
                                ...
                                <table class="table table-hover">
                                    <thead><tr></tr></thead>
                                    <tbody>
                                    <form method="post" action="changep.php"  enctype="multipart/form-data">
                                        <tr>                                            
                                            <td class="txt-oflo" style="width: 20%">Kata laulan Lama</td>
                                            <td><span class="font-medium"><input type="password" name="opass" required/></span></td>
                                        </tr>
                                        <tr>                                            
                                            <td class="txt-oflo">Kata Laluan Baru</td>
                                            <td><span class="font-medium"><input type="password" name="npass1" required/></span></td>
                                        </tr>                                        
                                        <tr>                                            
                                            <td class="txt-oflo">Kata Laluan Baru*</td>
                                            <td><span class="font-medium"><input type="password" name="npass2" required/></span></td>
                                        </tr>
                                        <tr>                                            

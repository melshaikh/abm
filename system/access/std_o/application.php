    ...
    <div id="main-wrapper" data-navbarbg="skin6" data-theme="light" data-layout="vertical" data-sidebartype="full" data-boxed-layout="full">
        ...
        if(isset($_GET['apply']))
        {
         ...
         if($ck = $db->query($sql))
         {
             ...
             if($db->query($sql))
                 $error = "MOHONAN ANDA DI PERJAYA";
             else $error = "MOHONAN ANDA TIDAK PERJAYA";
         }else $error = "MOHONAN ANDA TIDAK PERJAYA";
        }
        ?>
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                                ...
                                <div class="d-flex flex-row comment-row m-t-0">
                                    ...
                                    <div class="comment-text w-100">
                                        ...
                                        <div class="comment-footer">
                                            <span class="text-muted float-right" style="margin-right: 20%"><?php echo 'BUKA DARI '.$jx['sdate'].' HINGA '.$jx['closing_date'] ?></span>
                                            <?php $j = getJobStudentStat($jx['id'], $std['ic']); ?>
                                            <?php if(strcmp($j['status'],'APPLIED') == 0) { ?>
                                            <a class="btn btn-cyan" href="#" style="color: white">MOHONAN ANDA SEDANG PROCES</a>
                                            <?php } elseif(strcmp($j['status'],'ACCEPTED') == 0) { ?>
                                            <a class="btn btn-success" href="#" style="color: white"> MOHONAN ANDA DI TRIMAH</a>
                                            <?php } elseif(strcmp($j['status'],'REJECTED') == 0) { ?>
                                            <a class="btn btn-danger" href="#" style="color: white"> MOHONAN ANDA DI TOLAK</a>
                                            <?php } else { ?>
                                            <a class="btn btn-cyan" href="#" style="color: white">MOHONAN ANDA SEDANG PROCES</a>
                                            <?php }  ?>
                                        </div>
                ...
                <div class="row">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">STATUS PEMOHONAN</h4>
                            </div>
                        </div>
                                </div>
                </div>
                            ...
                            <div class="comment-widgets" >
                                <div class="d-flex flex-row comment-row m-t-0">
                                    ...
                                    <div class="comment-text w-100">
                                        ...
                                        <div class="comment-footer">
                                            <span class="text-muted float-right" style="margin-right: 20%"><?php echo 'BUKA DARI '.$j['sdate'].' HINGA '.$j['closing_date'] ?></span>
                                            <?php if(strcmp($j['status'],'APPLIED') == 0) { ?>
                                            <a class="btn btn-cyan" href="#" style="color: white">MOHONAN ANDA SEDANG PROCES</a>
                                            <?php } elseif(strcmp($j['status'],'ACCEPTED') == 0) { ?>
                                            <a class="btn btn-success" href="#" style="color: white"> MOHONAN ANDA DI TRIMAH</a>
                                            ...
                                            <a class="btn btn-cyan" href="#" style="color: white">MOHONAN ANDA SEDANG PROCES</a>
                                            <?php }  ?>
                                            <a class="btn btn-info" href="application.php?view=<?php echo $j['job_id'] ?>" style="color: white">VIEW</a>
                                        </div>
                                    </div>
                                </div>
                                </div>

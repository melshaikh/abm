    ...
    <div id="main-wrapper" data-navbarbg="skin6" data-theme="light" data-layout="vertical" data-sidebartype="full" data-boxed-layout="full">
        ...
        <div class="page-wrapper" >
            ...
            <?php if(isset($_POST['search'])) {
                $jlist = getCompanyJobsByUserId($loginuser['id'], $_POST['name']);
            } else 
            {
                $jlist = getCompanyJobsByUserId($loginuser['id'],' ');
            }
            ?>
                <div class="row">
                    <!-- column -->
                        ...
                        <div class="card">
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    <thead>
                                        <tr>
                                            <th class="border-top-0">Name Tawaran</th>
                                            <th class="border-top-0">Name Majikan</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>    
                                            ...
                                            <td><a href="jobs.php?view=<?php echo $std['id']?>#edit"><span class="label label-success label-rounded">view</span></a></td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
                                </table>

            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Senarai Permohon</h4>
                                ...
                                <table class="table table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="border-top-0">Tarikh Mohon</th>
                                            <th class="border-top-0">Status Memohonan</th>
                                            <th class="border-top-0">Pelatih Profil</th>
                                            <th class="border-top-0">offer/reject</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php if($j_list != NULL)
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="font-medium"><?php if(strcmp($std['cv_file'],'') != 0) { ?>
                                                <a href="../../../user_files/<?php echo $std['cv_file'] ?>">Download CV</a>

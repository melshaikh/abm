                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                         ...
                         <li class="sidebar-item">
                             <a class="sidebar-link waves-effect waves-dark sidebar-link" href="application.php" aria-expanded="false">
                                <i class="fas fa-users"></i>
                                <span class="hide-menu">STATUS PEMOHONAN</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="../../logoutstudent.php" aria-expanded="false">
                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right user-dd animated" >
                                ...
                                <a class="dropdown-item" href="resetpass.php"><i class="ti-wallet m-r-5 m-l-5"></i> Kata Laluan</a>
                            </div>
                        </li>
                        <!-- ============================================================== -->
                        <!-- User profile and search -->

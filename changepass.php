        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="">
                        <a class="page-scroll hvrNav-stat" href="index.php#about">TENTANG KAMI</a>
                    </li>
                    <li class="">
...
{   
    ...
    $sql = "SELECT * FROM `omr_users` WHERE `email` = '".$_POST['email']."'";
    if($ck = $db->query($sql)){
        if($ck->num_rows > 0){
            $us = $ck->fetch_assoc();
            $opass = $us['password'];
            ...
            $sql = "UPDATE `omr_users` SET `password` = '".$hashed."' WHERE `id`='".$us['id']."'";
            if($db->query($sql))
            {
                ...
                $error = 'PASSWORD IS SUCCESSFULLY RESET, NEW PASSWORD IS SENT TO YOUR EMAIL';
                    ...
                    $sql = "UPDATE `omr_users` SET `password` = '".$opass."' WHERE `id`='".$us['id']."'";
                    $db->query($sql);
                }
...
?>
    ...
    <section id="services" class="bg-light-gray">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <form name="sentMessage" method="post" action="changepass.php">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <input type="email" class="form-control" name="email" placeholder="Email Penguna *" required>

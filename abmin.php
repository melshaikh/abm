        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="">
                        <a class="page-scroll hvrNav-stat" href="#services">STAF ABM</a>
                    </li>
                    <li class="">
...
<div class="container"> 
    ...
    <div class="row">
                <div class="col-sm-12 text-center">
                    ...
                    <h3 class="section-subheading text-muted wow animated pulse animated" style="color: red"><?php echo $_GET['error'] ?></h3>                           
    ...
    <div class="row">
                <div class="col-sm-12">
                    <form name="sentMessage" method="post" action="system/login.php">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <input type="text" class="form-control" name="name" placeholder="Email Staf *" required>

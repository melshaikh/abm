            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="registration_monitor.php" aria-expanded="false">
                                <i class="fas fa-user-plus"></i>
                                <span class="hide-menu">PENDAFTARAN</span>
                            </a>
                        </li>
                         <li class="sidebar-item">
                             <a class="sidebar-link waves-effect waves-dark sidebar-link" href="sesi.php" aria-expanded="false">
                                <i class="fas fa-users"></i>
                                <span class="hide-menu">SESI</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="tred.php" aria-expanded="false">
                                <i class="mdi mdi-border-none"></i>
                                <span class="hide-menu">TRED</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="bidang.php" aria-expanded="false">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="company.php" aria-expanded="false">
                                ...
                                <span class="hide-menu">MAJIKAN</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="stat.php" aria-expanded="false">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="comments.php" aria-expanded="false">
                                ...
                                <span class="hide-menu">SOKONGAN</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
...
function printReg($page)
{
    ...
    echo '  <div class="col-md-12">
                    <ul class="list-inline row">
                        <li class="'.$list.' btn btn-outline-cyan" style="width: 10%">
                            <a href="registration_monitor.php">Senarai Sesi Daftaraan</a>
                        </li>
                        <li class="'.$baru.'btn btn-outline-cyan" style="width: 10%">
                            <a href="registration_group.php" >Masukan Data Pelatih</a>
                        </li>
                    </ul>
            </div>';
}

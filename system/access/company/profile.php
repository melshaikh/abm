...
<?php   
        ...
        if(isset($_POST['stdedit']))
        {
            ...
            if($db->query($sql))
            {
                $error = 'Student records is changed'.setBidangByShortAndIC($_POST['wclass'], $std['ic']);
                                ...
                                <table class="table table-row-variant m-t-20">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <a href="../../../user_files/<?php echo $std['cv_file'] ?>">download resume</a> <?php } else { ?> N/A <?php } ?></td>
                                        </tr>

	...
	<html lang="en">
        ...
        <div class="container" style="margin-top: 2%;">
            <div class="row" style="margin-right: 2%;">
                ...
                <?php if(isset($_GET['edit'])) { $editej= getJobsById($_GET['edit']); ?>
                    ...
                    <table class="table table-striped table-striped table-bordered">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="company" id="email" value="<?php echo $editej['name'] ?>" class="form-control" autocomplete="off"  /></td>                                            
                            </tr>
                            <tr>
                                <td style="width: 25%; padding-left: 2%;">Address</td>
                                <td><input type="text" name="address" value="<?php echo $editej['position'] ?>" class="form-control" autocomplete="off"  /></td>                                            
                            </tr>
                            <tr>
                                <td style="width: 25%; padding-left: 2%;">Email</td>
                                <td><input type="text" name="email" value="<?php echo $editej['email'] ?>" class="form-control" autocomplete="off"  /></td>                                            
                            </tr>
                            <tr>
                                <td style="width: 25%; padding-left: 2%;">Deskripsi</td>
                                <td><input type="text" name="description"  value="<?php echo $editej['detail'] ?>" class="form-control" autocomplete="off"  /></td>                                            
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td style="width: 25%; padding-left: 2%;">Posted Date</td>
                                <td><input type="text" name="date"  value="<?php echo $editej['date'] ?>" class="form-control" autocomplete="off"  /></td>                                            
                            </tr>
                            <tr>
                                <td style="padding-left: 2%;" colspan="2">
                                    <button style="width: 50%; float: right;" name="editjob" type="submit" class="btn btn-primary btn-lg">Edit Rekod</button>
                                </td>                                           
                            </tr>
                        </tbody>
                    </table>
                ...
                <div class="col-sm-7 col-sm-offset-0" style="margin-right: 2%; margin-bottom: 5%;">
                    <h3 style="color: red;">ARE YOU SURE TO DELETE THIS JOB OFFER </h3>
                    <form action="tusbpedite.php" method="post">
                        <input type="hidden" name="jid" value="<?php echo $_GET['delete']; ?>"/>
                        <button style="width: 25%; background-color: red;" name="deletejob" type="submit" class="btn btn-primary btn-lg">YES</button>
                        <button style="width: 25%; margin-left: 5%;" name="deletejobx" type="submit" class="btn btn-primary btn-lg">NO</button>
                    </form>               
                ...
                <?php } ?>
                <div class="col-sm-7 col-sm-offset-0" style="margin-right: 2%;">
            <?php 
            if(isset($_POST['deletejob']))
            {
                $sql = "DELETE FROM `jobs` WHERE `jobs`.`id` = ".$_POST['jid'];
                if(! $db->query($sql))
                    echo '<h3>'.$sql.'</h3>';
            }
            ...
            ?>
                    <?php
                    $joblist = getJobListByCompanyId($comp['id']);
                    $j = 1;
                    ...
                    <table class="table table-striped table-striped table-bordered">
                        ...
                        <tbody>
                            <?php while($job = $joblist->fetch_assoc()){ ?>
                            <tr>
                                <td><?php echo $j ?></td>
                                <td><?php echo $job['name'] ?></td>  
                                <td><?php echo $job['date'] ?></td>
                                <td><?php echo $job['company'] ?></td>
                                <td><a href="tusbpedite.php?edit=<?php echo $job['id'] ?>" style="color: green;">EDIT</a></td>
                                <td><a href="tusbpedite.php?delete=<?php echo $job['id'] ?>" style="color: red;">DELETE</a></td>
                            </tr>
                            <?php $j++;} ?>
                        </tbody>
                    </table>                    

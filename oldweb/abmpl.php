	...
	<html lang="en">
		...
		<body>
                ...
                <div id="loginWrap">
                    <div class="overlay">
                            <div class="container">
                                <form action="ambpl.php" method="post">
                                    <div class="row">
                                ...
                                <div class="col-sm-8 col-sm-offset-2">
                                                                <button name="searchstudent" type="submit" class="btn btn-primary btn-lg moved">Cari</button>
                                                        </div>
                                                    </form>
                            </div>
                    </div>
                    ...
                    <div class="overlay">
                            <div class="container">
                                ...
                                if(isset($_POST['searchstudent']))
                                {
                                    ...
                                    <tbody>';
                                    $sql = "false";
                                    if(strcmp($_POST['year'],"false")== 0 AND strcmp($_POST['area'],"false")== 0 AND strcmp($_POST['course'],"false")== 0)
                                        $sql = "NONO";
                                    if(strcmp($_POST['year'],"false")== 0 AND strcmp($_POST['area'],"false")== 0 AND strcmp($_POST['course'],"false")!= 0)
                                        $sql = "NONO";
                                    if(strcmp($_POST['year'],"false")== 0 AND strcmp($_POST['area'],"false")!= 0 AND strcmp($_POST['course'],"false")== 0)
